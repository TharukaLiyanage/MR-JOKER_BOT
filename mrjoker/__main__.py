...
MRJOKER_IMG = "https://www.linkpicture.com/view.php?img=LPic61ed6bf627d35654644857"

MRJOKER_AUD = "https://audio.jukehost.co.uk/kKJkdHgoMPeqdel4sDrEHr7m4U6o4Xya"


PM_START_TEXT = """
*Hello there*, *I*'*m* [White Tharukz](https://telegra.ph/file/9f78e297b33954a8a6f97.png)
*I am an White Themed Group Managing Bot and I will help in managing your group*
...
buttons = [
   ...
   # [
    ...
    [
        InlineKeyboardButton(text="➕ 𝐀𝐃𝐃 𝐖𝐡𝐢𝐭𝐞 𝐓𝐡𝐚𝐫𝐮𝐤𝐳 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏 ➕", url="http://t.me/Mrjokerlk_bot?startgroup=true"),
    ],
]
...
HELP_STRINGS = """
**SETTINGS**
**𝐂𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐝𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐚𝐛𝐨𝐮𝐭 𝐬𝐩𝐞𝐜𝐢𝐟𝐢𝐜 𝐦𝐨𝐝𝐮𝐥𝐞𝐬**[🤖](https://telegra.ph/file/9f78e297b33954a8a6f97.png)"""



DONATE_STRING = """ @TharukzGamingYT"""
...
def mrjoker_about_callback(update, context):
    ...
    if query.data == "mrjoker_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [𝐖𝐡𝐢𝐭𝐞 𝐓𝐡𝐚𝐫𝐮𝐤𝐳](https://t.me/TheOpenWorldTharukz) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/9f78e297b33954a8a6f97.png)"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="𝗬𝗢𝗨𝗧𝗨𝗕𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://www.youtube.com/c/TharukzGaming"
                        ),
                        InlineKeyboardButton(
                            text="𝐖𝐡𝐢𝐭𝐞 𝐓𝐡𝐚𝐫𝐮𝐤𝐳", url="https://t.me/TheOpenWorldTharukz"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, White Tharukz now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="𝗟𝗢𝗚'ꜱ 🤡", url="https://t.me/TheOpenWorldTharukz"),
                 ],
                 [
                    InlineKeyboardButton(text="𝗦𝗨𝗣𝗣𝗢𝗥𝗧 👥", url= "https://t.me/TheOpenWorldTharukz"),
                 ],
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR White Tharukz'S</b>\n"
            f"\nHere Some Developers Helping in Making The white Tharukz",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Tharuka", url="t.me/TharukzGamingYT"),
                    InlineKeyboardButton(text="NO NAME", url="t.me/Deleted_Account_2214"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..❤️ I'm *White Tharukz*
                 \nHere is the [❤️Source Code❤️](https://github.com/kmacprt/MR-JOKER-BOT) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝙄 𝘼ᴍ 𝘼ʟɪᴠᴇ ❤️")
        except Unauthorized:
            LOGGER.warning(
